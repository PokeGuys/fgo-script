...
function main()
    -- 關卡 (Stage): 星原と水晶の国 Rank Ex (Kingdom of Starfield and Crystals)
    -- 從者 (Servant): 蘭斯洛特 [Berserker] (Lancelot), 斯卡蒂 (Skadi) x2
    -- 禮裝 (CE): 萬華鏡 (Kscope), 隨意 (Any)
    -- Master裝備 (Mystic Codes): 2004年の断片 (Fragment of Year 2004)
    ...
    Game.addCommand(1, MasterSkillCommand:new(3, 1))
    ...
    Game.addCommand(3, ServantSkillCommand:new(2, 3, 1))
