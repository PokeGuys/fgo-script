...
function main()
    -- 從者 (Servant): 弗朗西斯・德雷克 (Francis Drake), 阿斯托爾福 (Astolfo),  孔明 (Waver) x2
    -- 禮裝 (CE): 隨意 (Any)
    ...
    Game.addCommand(2, MasterSkillCommand:new(1, 1))
    Game.addCommand(2, ServantSkillCommand:new(1, 1, nil))
    Game.addCommand(2, ServantSkillCommand:new(3, 2, nil))
    Game.addCommand(2, ServantSkillCommand:new(3, 1, 1))

    Game.addCommand(3, NPCommand:new(1))
    Game.addCommand(3, ServantSkillCommand:new(1, 3, 1))
    Game.addCommand(3, ServantSkillCommand:new(1, 2, nil))
