...
function main()
    -- 從者 (Servant): 阿爾托莉亞・潘德拉剛	[Saber] (Altria Pendragon), 莫德雷德 (Mordred),  孔明 (Waver) x2
    -- 禮裝 (CE): 隨意 (Any)
    ...
    Game.addCommand(3, NPCommand:new(2))
    ...
    Game.addCommand(3, ServantSkillCommand:new(2, 3, nil))
